...
internal static class TutorialContentBuilder
{
    public static string BuildBody()
    {
        return string.Join("\n\n",
            ...
            "Open it from Slay the Spire 2's built-in Modding screen. Better Mod Menu adds its Profile, Group, Backup, CSV, Logs, Style, and Help controls to that screen.",
            ...
            "Style customizes mod name colors inside the game. You can use the default Steam Workshop tag colors, override one supported tag, disable a tag color, or set a color for one specific mod id or displayed mod name.",
