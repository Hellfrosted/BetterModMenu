...
internal static class TutorialContentBuilder
{
    public static string BuildBody()
    {
        return string.Join("\n\n",
            ...
            "Backup saves copies of your Better Mod Menu profiles, groups, and the game's current enabled-mod settings. Load lets you choose a profile and group backup to restore. CSV creates a spreadsheet-friendly list of installed mods, versions, links, enabled state, and group names.",
